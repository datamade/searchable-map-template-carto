...
If you don't have or want a CARTO account, check out [Searchable Map Template - Turf](https://github.com/datamade/searchable-map-template-turf/).
...
* **Powered by CARTO instead of Fusion Tables**. While they are similar platforms, CARTO is built on top of an open source stack with postgres and uses Leaflet for rendering the maps. This translates into syntax changes in the javascript API, most of which I've abstracted away into `cartodb_lib.js`.
